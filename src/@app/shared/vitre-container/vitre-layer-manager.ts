...
export function debug(...args) {
  let prefix = 'layer manager'
  console.log('%c' + prefix, 'font-weight: bold; color: green;', ...args)
}

export class VitreLayerManager {
  ...
  constructor(
      ...
      private layers: VitreLayerComponent[],
  ...
  private listen() {
    ...
    const end = (velocity) => {
      ...
      this.detector.moveSwipe = VitreLayerManager.NOOP
      this.detector.endSwipe = VitreLayerManager.NOOP
